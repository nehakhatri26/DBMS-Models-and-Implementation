			...
			try {
				...
				case 3:
					...
					if(keyType!= AttrType.attrInteger)
						System.out.println("Error: Input values can only be Integers");
					if (flag == 0) {
						while (i < 100) {
							key = (arr[i] = sum += 1);
							if (key < 0)
